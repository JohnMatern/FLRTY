 ...
 */
contract CurrencyCoin is IERC20, EIP712MetaTransaction {
     ...
     * construction.
     */
    constructor (string memory name_, string memory symbol_, address gov_) EIP712MetaTransaction(name_, "1") {
        _name = name_;
        _symbol = symbol_;
        _decimals = 2;
        communityOnly = true;
    ...
    function fundProject(address project, uint256 amount) external onlyGov {
