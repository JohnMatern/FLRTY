...
/**
 * @dev Test meta tx enabled ERC-20 Token
 */
 
contract Test is IERC20, EIP712MetaTransaction {
     ...
     * construction.
     */
    constructor (string memory name_, string memory symbol_) EIP712MetaTransaction(symbol_, "1") {
        _name = name_;
        _symbol = symbol_;
